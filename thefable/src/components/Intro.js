  ...
  return (
    <Container
      ...
      style={{
        top: "15%",
        bottom: "25%",
        background: "rgba(248, 202, 182,0.5)"
      }}
    >
      <Top />
      <div className="row">
        <span
          className="col-12 col-sm-12 col-md-12 col-lg-12  font1 pt-4"
          style={{
            fontSize: "96px",
            color: "#BC4E71",
        ...
        <span
          className="col-xm-12 bdy col-sm-12 col-md-12 col-lg-12 fs-5 d-flex flex-column justify-content-center justify-self-center"
          style={{
            color: "#721935"
          }}
        >
